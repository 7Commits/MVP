...
@patch("services.evaluation_service.openai_service.get_openai_client")
...
@patch("services.evaluation_service.openai_service.get_openai_client", return_value=None)
