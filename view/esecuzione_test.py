...
# Carica sempre i dati necessari dal database
...
def get_question_data(question_id):
    if 'questions' in st.session_state and not st.session_state.questions.empty:
        ...
        if not question_row.empty:
            # Assicurati che i nomi delle colonne ('domanda', 'risposta_attesa') coincidano con quelli
            # forniti da question_controller.load_questions()
        ...
        if not gen_preset_config or not eval_preset_config:
            ...
            with st.spinner("Generazione risposte e valutazione LLM in corso..."):
                ...
                if results:
                    ...
                    result_id = add_result(selected_set_id, result_data)
